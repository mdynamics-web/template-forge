...
export const ContactSection = () => {
  ...
  const trustSignals = [
        ...
        {
          icon: Mail,
          text: t("trust.signals.2.text"),
        },
        {
          icon: Clock,
          text: t("trust.signals.3.text"),
        },
      ]
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="nueva-web">{t("form.services.0.label")}</SelectItem>
                      <SelectItem value="mejorar-web">
                        {t("form.services.1.label")}
                      </SelectItem>
                      <SelectItem value="seo">
                        {t("form.services.2.label")}
                      </SelectItem>
                      <SelectItem value="tienda">{t("form.services.3.label")}</SelectItem>
                      <SelectItem value="no-seguro">
                        {t("form.services.4.label")}
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
