...
export const HeroSection = () => {
  ...
  const metrics = [
    {
      end: Number(tv("metrics.m1.value")),
      suffix: tv("metrics.m1.suffix"),
      label: tv("metrics.m1.label"),
    },
    {
      end: Number(tv("metrics.m2.value")),
      suffix: tv("metrics.m2.suffix"),
      label: tv("metrics.m2.label"),
    },
    {
      end: Number(tv("metrics.m3.value")),
      suffix: tv("metrics.m3.suffix"),
      label: tv("metrics.m3.label"),
    },
  ];
      ...
      >
        ...
        >
          ...
          <span className="relative">
            <span className="gradient-text">{tv("titleHighlight")}</span>
            <motion.div
