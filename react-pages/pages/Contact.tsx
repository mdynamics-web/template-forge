          ...
          <div className="grid lg:grid-cols-5 gap-12">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6 p-8 rounded-2xl bg-card border border-border card-shadow">
                  ...
                  <div className="grid sm:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select onValueChange={(val) => setFormData({ ...formData, service: val })}>
                        ...
                        <SelectContent>
                          <SelectItem value="website">{t("contact.service.website")}</SelectItem>
                          <SelectItem value="seo">{t("contact.service.seo")}</SelectItem>
                          <SelectItem value="chatbot">{t("contact.service.chatbot")}</SelectItem>
                          <SelectItem value="redesign">{t("contact.service.redesign")}</SelectItem>
                          <SelectItem value="automation">{t("contact.service.automation")}</SelectItem>
                          <SelectItem value="platform">{t("contact.service.platform")}</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" placeholder={t("contact.message.placeholder")} rows={5} value={formData.message} onChange={(e) => setFormData({ ...formData, message: e.target.value })} className="bg-background resize-none" maxLength={2000} />
                  </div>
            ...
            >
              ...
              <div className="p-6 rounded-2xl gradient-bg text-primary-foreground">
                ...
                <p className="text-primary-foreground/70 text-sm leading-relaxed mb-4">{t("footer.consultation.desc")}</p>
