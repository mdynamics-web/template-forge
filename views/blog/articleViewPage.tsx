    ...
    <div className="min-h-screen bg-background">
      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        >
          <ReactMarkdown
            components={{
              ...
              h3: ({ children }) => (
                <h3 className="font-display font-bold text-xl text-foreground mt-10 mb-4">
                  {children}
                </h3>
              ),
              p: ({ children }) => (
              ...
              li: ({ children }) => (
                <li className="text-muted-foreground text-[15px] leading-relaxed pl-2">
              ...
              blockquote: ({ children }) => (
                <blockquote className="border-l-2 border-secondary pl-6 my-8 py-2">
                  <div className="text-foreground/85 italic text-lg font-display">
                    {children}
                  </div>
                </blockquote>
              ),
              ...
              td: ({ children }) => (
                <td className="px-4 py-3 text-muted-foreground border-t border-border/10">
                  {children}
                </td>
              ),
              ...
              pre: ({ children }) => (
                <pre className="my-6 overflow-x-auto rounded-xl bg-card/70 border border-border/30 p-5 text-sm text-foreground leading-relaxed font-mono">
                  {children}
                </pre>
              ),
            }}
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="mt-20 p-8 md:p-12 rounded-2xl border border-secondary/20 bg-secondary/10 text-center"
        >
      ...
      {related.length > 0 && (
        <section className="max-w-6xl mx-auto px-6 pb-24">
          <div className="flex items-center gap-6 mb-10">
            <h3 className="font-display font-bold text-xl text-foreground whitespace-nowrap">
              {t("relatedArticles")}
            </h3>
              ...
              <Link key={p.slug} href={`/${locale}/blog/${p.slug}`} className="group block">
                <div className="rounded-2xl border border-border/30 bg-card/80 overflow-hidden hover:border-secondary/30 transition-all duration-500">
                  ...
                  <div className="p-6">
                    ...
                    <h4 className="font-display font-bold text-lg text-foreground mt-2 group-hover:text-secondary transition-colors">
                      {p.title}
                    </h4>
                  </div>
                </div>
